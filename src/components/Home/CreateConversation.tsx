  ...
  return (
    ...
    >
      <div
        ...
        className="mx-3 w-full max-w-[500px] overflow-hidden rounded-lg bg-dark"
      >
        ...
        {loading ? (
          ...
          <>
              ...
              {data?.docs
                ...
                .map((doc) => (
                  <div
                    ...
                    className="flex cursor-pointer items-center gap-2 px-5 py-2 transition hover:bg-dark-lighten"
                  >
                    <input
            ...
            <div className="flex justify-end border-t border-dark-lighten p-3">
              <button
                disabled={selected.length === 0}
                onClick={handleCreateConversation}
                className="rounded-lg bg-dark-lighten py-2 px-3 transition duration-300 hover:brightness-125 disabled:!brightness-[80%]"
              >
                Start conversation
              </button>
            </div>
